...
public class CombatMission : AMission
{
    ...
    public override float Completion => 1f - (float)enemyGroup.EnemyCount / enemyGroup.MaxEnemyCount;
    ...
    public override List<WayPoint> WayPoints {
        get {
            ...
            {
                if (child.CompareTag("Enemy")) wayPoints.Add(new WayPoint(child.gameObject, child.name));
            }
